            ...
            <div style={{ width: 'fit-content', border: '1px solid black', borderCollapse: 'collapse', margin: '4px', textAlign: 'center' }}>
                ...
                {customerData && (customerData.mobileNo || customerData.customerName || customerData.address || customerData.locality) ?
                    <div style={{  padding: '8px 4px 8px 4px ', width: '309px', height: 'min-content', borderTop:'2px solid black' }}>
                        <div style={{ textAlign: 'start', marginTop: '6px', fontSize:'14px' }}>
                ...
                <div className="main_bill h-min">
                    <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                        <thead>
                            <tr>
                                <th style={{ border: '1px solid black', paddingTop: '2px', paddingBottom: '2px', borderLeft: '0px', textAlign: 'start' }}>Items</th>
                                <th style={{ border: '1px solid black', paddingTop: '4px', paddingBottom: '4px', borderRight: '0px', textAlign: 'center', width: '20%' }}>Qty</th>
                            </tr>
                        </thead>
                        <tbody>
                            {itemList?.map((item) => (
                                <tr>
                                    <td style={{ border: '1px solid black', width: '80%', fontWeight: '700', paddingTop: '6px', lineHeight: '30px', paddingLeft: '4px', paddingRight: '4px', paddingBottom: '6px', fontSize: '18px', borderLeft: '0px', textAlign: 'start' }}>{item.inputName.itemName} <br /> {item.comment && <span className="text-xs" style={{ fontSize: '16px', marginTop: '4px' }}>({item.comment})</span>} </td>
                                    <td style={{ border: '1px solid black', padding: '4px 0px 4px 0px', borderRight: '0px', textAlign: 'center', width: '20%' }}>{item.qty} {item.unit}</td>
                                </tr>
                            ))
                            }
                            {/* <tr>
                ...
                {
                    <div style={{ padding: '2px', width: '313px', height: 'min-content', borderTop: '1px solid black' }}>
                        <div style={{ textAlign: 'start', width: '100%' }}>
                            <div style={{ textAlign: 'start', fontSize: '16px', fontWeight: '500' }}>
