...
const PickUp1 = () => {
  ...
  const toggleBillingMenu = () => {
    setBillineMenu(true);
    setDineInCustomerDetails(true)
    setDeliveryCustomerDetails(true)
    setPickUpCustomerDetails(true)
  };
            ...
            <div className="w-3/4 bg-gray-100 ">
              <div className="flex m-2 p-2 flex-wrap">
                <div className="main_card">
                  <div className="card overflow-hidden flex bg-white shadow-xl rounded-lg m-2">
        ...
        <section className="left_Section w-1/2">
          <div className="w-full h-full">
            <div className=" w-full p-0 text-white">
              <div className="grid w-full grid-flow-row grid-cols-12  bg-gray-700">
                <div onClick={toggleBillingMenu} className={buttonCLicked === 'tab1' ? "clicked col-3 p-0 col-span-3 text-center" : 'col-3 p-0  col-span-3 text-center'}>
                ...
                <div onClick={toggleBillingMenu} className={buttonCLicked === 'tab2' ? "clicked col-3 p-0  col-span-3 text-center" : 'col-3 p-0  col-span-3 text-center'}>
                ...
                <div onClick={toggleBillingMenu} className={buttonCLicked === 'tab3' ? "clicked col-3 p-0  col-span-3 text-center" : 'col-3 p-0  col-span-3 text-center'}>
                ...
                <div onClick={toggleBillingMenu} className={buttonCLicked === 'tab4' ? "clicked col-3 p-0  col-span-3 text-center" : "col-3 p-0  col-span-3 text-center"}>
            ...
            <div className="bill_tag_12 ">
              ...
              <div className="mr-2 p-0 ">
                ...
                <div className="main_bill2 h-full">
                  {
                    items.length === 0 && (
                      <div className='text-center mt-12 bill_tag h-full'>
                        <div>
          ...
          <div className="w-full p-2  bg-gray-700 text-white">
          ...
          <div className="w-full flex justify-between p-1 mt-1 ">
            ...
            <div>
              <Button1>Print & Bill</Button1>
            </div>
            <div>
              <Button1 className='another_1'>KOT</Button1>
            </div>
            <div>
              <Button1 className='another_1'>KOT & PRINT</Button1>
            </div>
            <div>
              <Button1 className='another_2'>HOLD</Button1>
            </div>
          </div>
        </section>
      </div>
